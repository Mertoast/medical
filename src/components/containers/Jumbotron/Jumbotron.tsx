  ...
  return (
    <div className={styles.container}>
      ...
      <div className={`${styles.position} ${styles['position-girl']}`}>
        <img src="/static/tech 1.png" className={styles.girl} alt="This is a tech girl" />
      </div>
      <div className={`${styles.position} ${styles['position-calendar']}`}>
        <img src="/static/img 3.png" className={styles.girl} alt="This is a tech girl" />
      </div>
      <div className={`${styles.position} ${styles['position-graph']}`}>
        <img src="/static/img 1.png" className={styles.girl} alt="This is a tech girl" />
      </div>
